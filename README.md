A hacky codebase that allows you to visualise the haptic device pointer and a vector at some fixed displacement from the the pointer in its local coordinate frame
